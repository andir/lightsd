...
inline std::string getValueOrDefault(const std::string& name,
...
HSVUDPOutput::HSVUDPOutput(const YAML::Node& params)
    : HSVUDPOutput(getValueOrDefault("host", params, "127.0.0.1"),
                   getValueOrDefault("port", params, "1338")) {}

HSVUDPOutput::HSVUDPOutput(const std::string& destination,
